...
2. LOAD THE DOCTRINE, IN THIS ORDER. ${TRADING_GET_PLAYBOOK_TOOL} takes a name: call it with "classify" first to read the regime, then with the mode that regime selects ("momentum", "range_reversion", or "opening_range"), then with "standing_rules", which holds in every mode. Follow the procedure, gates, and stand-down conditions it returns.

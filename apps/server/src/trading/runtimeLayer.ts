 ...
 *
 * Both are plain SQL-backed services over the migration-035 tables; they hold
 * no process, no socket, and no provider state, so the whole trading layer is
 * just these two on top of `SqlClient`.
 *

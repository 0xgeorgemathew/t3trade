    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active T3 Trades agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow T3 Trades to connect to T3 Trades servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow T3 Trades to access your camera so you can scan pairing QR codes.",

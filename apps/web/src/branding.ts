...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? T3_FORK_NAME;
...
export const APP_FORK = T3_FORK_NAME;
export const APP_T3_UPSTREAM_COMMIT = T3_UPSTREAM_COMMIT;

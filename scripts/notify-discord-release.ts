  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new T3 Trades prerelease is available for nightly testers."
          : "A new T3 Trades latest release is available.",
...
).pipe(Command.withDescription("Post a T3 Trades release announcement to Discord."));

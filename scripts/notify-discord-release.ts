  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new T3 Trade prerelease is available for nightly testers."
          : "A new T3 Trade latest release is available.",
...
).pipe(Command.withDescription("Post a T3 Trade release announcement to Discord."));
